			...
			<span className="flex items-center gap-2 text-sm">
				...
				>
					<SwitchPrimitives.Thumb
						className={clsx(
							'pointer-events-none block rounded-full bg-base shadow-lg ring-0 transition-transform group-disabled:bg-weak-foreground group-disabled:shadow-none data-[state=unchecked]:translate-x-0',
							{
