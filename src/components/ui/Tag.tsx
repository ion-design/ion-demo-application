...
const classNames = cva(['disabled:border-transparent disabled:bg-weak', 'active:bg-transparent'], {
	variants: {
		color: {
		...
		return (
			<button
				...
				className={clsx(
					...
					'flex w-fit flex-row leading-none items-center justify-center gap-x-1 rounded-lg border px-3 py-1 text-xs font-semibold transition-all',
					className
				)}
				{...props}
			>
